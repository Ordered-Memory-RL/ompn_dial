import numpy as np
from jacopinpad.jacopinpad_tools import env_init, move_to_position, default_controller_init, \
...
class jacopinpad(Env):
    ...
    def step(self, action):
        ...
        for i in range(self.action_repeat):
            ...
            reward, done, i = self.check(d_xyz, terminate)
